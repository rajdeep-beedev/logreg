...
<body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container">
            <a class="navbar-brand" href="#!">{{(Auth::user())?'Hi, '.Auth::user()->first_name.' '.Auth::user()->last_name:''}}</a>
                ...
                <div class="col-xl-6">
                    <div class="text-center text-white">
                        ...
                        <form  class="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input class="form-control form-control-lg" name="email" id="emailAddress" type="email"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form action="{{Request::root().'/login'}}" method="POST" class="row g-3 needs-validation" novalidate>
                                @csrf
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Username or Email Address</label>
                                    <input type="text" name="email" class="form-control" id="validationCustom01" value="{{old('email')}}"
                                        required>
                                        @error('first_name')
        ...
        <div class="modal fade" id="Signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form action="{{Request::root().'/user-register'}}" method="post" class="row g-3 needs-validation" novalidate >
                                @csrf
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">First Name</label>
                                    <input type="text" name="first_name" class="form-control" id="validationCustom01" value="{{old('first_name')}}"
                                        required>
                                        @error('first_name')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="last_name" class="form-control" id="validationCustom01" value="{{old('last_name')}}"
                                        required>
                                        @error('last_name')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" name="user_mob"class="form-control" id="validationCustom06"value="{{old('user_mob')}}"
                                        required>
                                        @error('user_mob')
                                        <span class="text-danger"><strong>{{$errors->first('user_mob')}}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    <label for="validationCustom03" class="form-label">Email Address</label>
                                    <input type="email"  name="email" class="form-control" id="validationCustom03" value="{{old('email')}}"
                                        required>
                                        @error('email')
                                        <span class="text-danger"><strong>{{$errors->first('email')}}</strong></span>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="password" name="user_password"class="form-control" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                  </div>
                                  @error('user_password')
                                    <span class="text-danger"><strong>{{$errors->first('user_password')}}</strong></span>
                                @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="password" name="user_cpass" class="form-control" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                    @error('user_cpass')
                                    <span class="text-danger"><strong>{{$errors->first('user_cpass')}}</strong></span>
                                @enderror
                                  </div>
                                  <div class="col-12">
                                    <div class="form-check">
                                      <input class="form-check-input" type="checkbox" name="terms" value="1" id="invalidCheck" required>
                                      <label class="form-check-label" for="invalidCheck">
